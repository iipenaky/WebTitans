...
function editReservation(reservationId) {
	...
	document.getElementById("editReservationDateTime").value =
...
document
	.getElementById("editReservationForm")
	.addEventListener("submit", function (event) {
		...
		reservation.position_id = parseInt(
			document.getElementById("editPositionId").value,
		);
		reservation.customer_id = parseInt(
			document.getElementById("editCustomerId").value,
		);
		reservation.table_id = parseInt(
			document.getElementById("editTableId").value,
		);
		reservation.reservation_datetime = document.getElementById(
			"editReservationDateTime",
		).value;
		reservation.number_of_guests = parseInt(
